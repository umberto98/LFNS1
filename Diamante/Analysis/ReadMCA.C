...
void ReadMCA () {
    ...
    for(int i=50;i<=500;i=i+50) {
        ...
        while(inputpos>>fillhpos) {
            if(fillhpos>10) hpos[cntpos]->SetBinContent(cntbinhpos++,fillhpos); //legge i canali
            else hpos[cntpos]->SetBinContent(cntbinhpos++,0.);
        }
        ...
        while(inputneg>>fillhneg) {
            if(fillhneg>10) hneg[cntneg]->SetBinContent(cntbinhneg++,fillhneg); //legge i canali
            else hneg[cntneg]->SetBinContent(cntbinhneg++,0); //noise
        }
